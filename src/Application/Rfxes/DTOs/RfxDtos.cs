...
public record RfxListItemDto(Guid Id, string Title, RfxType Type, string Category, string Department, DateTime ClosingDate, string Priority);

public class RfxUpsertDto   // for Create/Update
{
